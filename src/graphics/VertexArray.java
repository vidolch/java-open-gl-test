...
public class VertexArray {
    ...
    public VertexArray(float[] verticies, byte[] indecies, float[] textureCoordinates) {
        ...
        glVertexAttribPointer(Shader.TEXTURE_COORDINATE, 3, GL_FLOAT, false, 0, 0);
        glEnableVertexAttribArray(Shader.TEXTURE_COORDINATE);
